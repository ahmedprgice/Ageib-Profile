...
export function Experience() {
  const experiences = [
    ...
    },
    {
      ...
      description:
        "Contributed to technical skill development initiatives by organizing workshops, leading hands-on sessions, and supporting peer learning within the university.",
      achievements: [
            ...
            {experiences.map((exp, index) => (
              ...
              >
                ...
                >
                  ...
                  {/* Card */}
                  <div className="bg-card border border-border rounded-lg p-6 hover:border-primary/30 transition-all text-left">
                    <h3 className="text-2xl mb-1 text-left">{exp.role}</h3>
                    <p className="text-primary mb-4 text-left">{exp.company}</p>
